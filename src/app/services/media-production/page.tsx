...
export default function Page() {
  return (
    <main className="min-h-screen bg-brand-white dark:bg-[#1a1c1e]">
      ...
      <Hero 
        title="Event Media Production Services for B2B Brands"
        subtitle="We deliver excellence through strategy, design, and technology."
      />

      <section className="py-24 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">Content coming soon for Event Media Production Services for B2B Brands</h2>
