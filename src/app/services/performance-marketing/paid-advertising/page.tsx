...
export default function Page() {
  return (
    <main className="min-h-screen bg-brand-white ">
      ...
      <Hero 
        title="Paid Advertising for B2B Lead Generation"
        subtitle="We deliver excellence through strategy, design, and technology."
      />

      <section className="py-24 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">Content coming soon for Paid Advertising for B2B Lead Generation</h2>
