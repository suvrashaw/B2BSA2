    ...
    <section className="bg-brand-gray px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
        <div className="space-y-4">
          ...
          <h2 className="font-display text-3xl leading-tight font-bold text-brand-primary sm:text-4xl">
            Optimized video delivery without the page-speed penalty
          </h2>
          <p className="max-w-xl text-base leading-7 text-brand-primary/70">
            Media assets now run through next-video, with adaptive Mux playback, generated poster
            imagery, and a crawler-friendly player foundation for production pages.
          </p>
        </div>
        <div className="overflow-hidden rounded-lg border border-white/70 bg-white shadow-xl shadow-brand-blue/10">
          <Video
