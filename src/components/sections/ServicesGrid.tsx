          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <Link href={service.href} className="block h-full p-8 rounded-3xl bg-brand-gray/5 border border-brand-charcoal/5 hover:border-brand-blue/30 transition-all duration-300 hover:shadow-2xl hover:shadow-brand-blue/10 flex flex-col justify-between">
                  <div>
