            ...
            <div className="grid lg:grid-cols-12 gap-16 mb-16">
              ...
              <div className="lg:col-span-5">
                ...
                <div className="flex items-center gap-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-brand-cyan hover:bg-brand-blue hover:text-white hover:border-brand-blue transition-all duration-300">
              ...
              <div className="lg:col-span-3">
                <h4 className="font-heading font-bold text-lg text-white mb-6">Stay Ahead</h4>
                <p className="text-sm text-gray-400 mb-4">Subscribe to our enterprise growth newsletter.</p>
                <div className="relative pointer-events-auto">
                  <input 
                    type="email" 
                    placeholder="Work Email" 
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-brand-blue transition-colors text-sm"
                  />
