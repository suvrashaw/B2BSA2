...
export const HPMI_WHY = {
  ...
  heading: (<>Why Human Research <br /><span className="text-brand-cyan">Outperforms Automation</span></>),
  reasons: [
    { id: "nuance", title: "Captures What Data Can't", description: "Buyer sentiment, competitor positioning shifts, and emerging market dynamics require human analysts — not algorithms.", image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=1200" },
    { id: "primary", title: "Primary Research Access", description: "We conduct direct interviews with buyers, industry experts, and competitors — intelligence no third-party database can provide.", image: "https://images.unsplash.com/photo-1551818255-e6e10975bc17?auto=format&fit=crop&q=80&w=1200" },
    { id: "strategic", title: "Actionable Strategic Output", description: "Every report is structured for executive decision-making — not raw data dumps, but clear findings and recommended actions.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200" },
    { id: "custom", title: "Fully Custom Scope", description: "We research exactly what you need — a specific competitor, a new market, a buyer segment — with no generic templates.", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=1200" },
  ],
};

export const HPMI_DELIVERABLES = {
  eyebrow: "WHAT'S INCLUDED",
  heading: (<>Market Intelligence <br /><span className="text-transparent bg-clip-text bg-linear-to-r from-brand-blue to-brand-cyan">Research Services</span></>),
...
export const HPMI_STATS = {
  heading: (<>Research Quality <br /><span className="text-brand-blue">Impact Numbers</span></>),
...
export const HPMI_TESTIMONIALS = {
  ...
  heading: (<>Leaders Who Made <br /><span className="text-[#1E6091]">Better Decisions Faster</span></>),
  autoplayInterval: 3500, initialIndex: 1,
  testimonials: [
    { id: 1, name: "Michael Chen", designation: "VP of Global Sales", company: "Aura Systems", rating: 5, quote: "The competitive intelligence report revealed a $12 million product gap we'd been completely blind to. That single piece of research reshaped our entire product roadmap.", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=400" },
    { id: 2, name: "Sarah Jenkins", designation: "Chief Marketing Officer", company: "Nexus Technologies", rating: 5, quote: "The buyer research they conducted gave us direct quotes and frameworks from our actual ICP. It transformed how we write copy, pitch decks, and proposals.", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400" },
    { id: 3, name: "Elena Rodriguez", designation: "Director of Brand Activation", company: "Vortex Labs", rating: 5, quote: "Board-ready research delivered in 2 weeks. The quality and depth of insight from primary interviews is something no data tool could ever replicate.", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=400" },
  ],
};
...
export const HPMI_FAQ = {
  ...
  scrollAmount: 340,
  faqs: [
    { id: "scope", question: "How do you define the research scope?", answer: "We start with a 60-minute briefing call to understand your strategic question, existing knowledge, and decision timeline. We then propose a research design with methodology, timeline, and deliverables." },
    { id: "primary", question: "How do you recruit interview respondents?", answer: "We have a global network of B2B professionals across 40+ industries. For niche segments, we use professional panels and social outreach. We recruit to your exact ICP specification." },
    { id: "turnaround", question: "How long does a research project take?", answer: "Competitive intelligence reports: 1–2 weeks. Buyer research studies (20+ interviews): 4–6 weeks. Market sizing studies: 2–4 weeks. Timelines depend on research scope and recruitment complexity." },
    { id: "format", question: "What does the final deliverable look like?", answer: "A structured PDF report with executive summary, key findings, data visualisations, and strategic recommendations — ready to present to your board or leadership team without additional formatting." },
    { id: "confidentiality", question: "Is our research brief kept confidential?", answer: "Absolutely. We sign NDAs before every engagement and never disclose client identities to respondents. All research is conducted under our independent research brand." },
  ],
};

export const HPMI_CONTACT = {
  eyebrow: "COMMISSION RESEARCH",
  heading: (<>Get the Intelligence <br /><span className="text-transparent bg-clip-text bg-linear-to-r from-brand-blue to-brand-cyan">to Make Bold Moves</span></>),
  description: "Tell us your strategic question and we'll design a research programme to answer it — with confidence.",
  ...
  form: {
    ...
    serviceLabel: "Research Type", servicePlaceholder: "Select research type...",
    serviceOptions: [
    ...
    messageLabel: "Describe Your Research Question", messagePlaceholder: "What strategic decision are you trying to make? What do you need to know?",
