import { BarChart3, Globe2, Layers, MapPin, Presentation, Target, TrendingUp, Users, Zap } from "lucide-react";
  ...
  items: [
    {
      id: "gitex-2025",
      client: "GITEX 2025",
      title: "340% Lead Surge at the World's Largest Tech Show",
      challenge: "Generic presence among 6,000 exhibitors with no differentiation.",
    ...
    },
    {
      ...
      challenge: "Competing against hyperscalers for mindshare on the show floor.",
...
export const GES_FAQ = {
  ...
  description: "Everything you need to know about our global event solutions.",
  scrollAmount: 340,
  faqs: [
    {
      id: "timeline",
...
export const GES_CONTACT = {
  ...
  form: {
    ...
    serviceOptions: [
      { value: "booth-design", label: "Trade Show Booth Design" },
      { value: "event-lead-gen", label: "Event Lead Generation" },
      { value: "industry-events", label: "Industry Events Management" },
      { value: "custom-events", label: "Custom Events" },
      { value: "booth-rental", label: "Booth Rental" },
    ],
    messageLabel: "Tell Us About Your Event Goals",
