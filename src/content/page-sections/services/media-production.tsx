import { BarChart3, Camera, Clapperboard, MonitorPlay, Radio, Target, TrendingUp, Users, Video } from "lucide-react";
  ...
  services: [
    {
      ...
      description: "Live event capture, highlights reels, and post-event content packages that extend your show floor ROI.",
      icon: Camera,
    ...
    },
    {
      ...
      description: "Brand films, product explainers, and executive thought leadership videos at broadcast quality.",
      icon: Clapperboard,
    ...
    },
    {
      ...
      description: "Post-production, colour grading, motion graphics, and delivery-ready mastering for all platforms.",
      icon: MonitorPlay,
    ...
    },
    {
      ...
      description: "Multi-camera, broadcast-grade live streams for conferences, product launches, and virtual events.",
      icon: Radio,
      image: "https://images.unsplash.com/photo-1598743400863-0201c7e1445b?auto=format&fit=crop&q=80&w=1600",
      color: "bg-brand-blue",
    },
    {
      id: "testimonials",
      title: "Video Testimonials",
      description: "Professionally filmed client success stories that convert prospects more effectively than any written review.",
      icon: Users,
    ...
    },
    {
      ...
      description: "Pre-roll, in-stream, and bumper ad campaigns on YouTube engineered specifically for enterprise B2B audiences.",
      icon: Video,
  ...
  reasons: [
    {
      ...
      description: "We understand enterprise buying committees, long sales cycles, and the specific trust signals that B2B buyers respond to. Our content is engineered for this.",
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=1200",
    },
    {
      id: "broadcast-quality",
      title: "Broadcast-Grade Production",
      description: "Cinema-quality cameras, professional lighting rigs, and Dolby-certified audio for every project — regardless of scope.",
    ...
    },
    {
      ...
      description: "We don't just point and shoot. Every production begins with a content strategy session to ensure the video serves a specific pipeline objective.",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200",
    },
    {
      id: "fast-turnaround",
      title: "Fast, Reliable Delivery",
      description: "We deliver on time, every time. Our production pipeline ensures 4–6 week turnaround from brief to delivery-ready master files.",
...
export const MEDIA_CASE_STUDIES = {
  ...
  items: [
    ...
    },
    {
      ...
      solution: "60-second hero video + 3 feature explainers distributed across LinkedIn and YouTube.",
      metric: "2,000",
...
export const MEDIA_BLOGS = {
  ...
  blogs: [
    ...
    },
    {
      ...
      category: "Events",
      date: "Aug 28, 2025",
      image: "https://images.unsplash.com/photo-1598743400863-0201c7e1445b?auto=format&fit=crop&q=80&w=800",
    },
    {
      id: 3,
  ...
  faqs: [
    {
      ...
      answer: "Standard corporate video projects deliver in 4–6 weeks from brief to final delivery. Expedited 2-week production is available at a premium. Event coverage is delivered within 5 business days.",
    },
    {
      id: "location",
      question: "Do you film internationally?",
      answer: "Yes. Our production crews operate globally. We have partners in 40+ countries and regularly film at events, corporate offices, and studios across EMEA, APAC, and the Americas.",
    },
    {
      id: "formats",
      question: "What formats do you deliver?",
      answer: "We deliver in all standard formats: H.264/H.265 for web, ProRes for broadcast, and platform-optimised versions for LinkedIn, YouTube, and your website.",
    },
    {
      id: "scripting",
      question: "Do you handle scripting and storyboarding?",
      answer: "Yes. Every production includes pre-production services: creative brief, script or shot list development, and storyboard review before a single camera rolls.",
    },
    {
      id: "revisions",
      question: "How many revisions are included?",
      answer: "Standard projects include 2 rounds of edit revisions. Our revision process is structured and efficient — most clients don't need more than one round.",
    },
  ],
};
...
export const MEDIA_CONTACT = {
  ...
  description: "Tell us about your video production needs and we'll scope a production that drives real B2B results.",
  illustration: {
