...
export const VES_WHY = {
  ...
  heading: (<>Why Professional Editing <br /><span className="text-brand-cyan">Changes Everything</span></>),
  reasons: [
    { id: "quality", title: "Brand-Consistent Quality", description: "Every cut, colour grade, and motion graphic follows your brand guidelines to the pixel.", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1200" },
    { id: "speed", title: "Fast Turnaround", description: "Standard edits delivered in 48 hours. Urgent same-day edits available for event content.", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=1200" },
    { id: "platform", title: "Platform-Native Formats", description: "Every video delivered in the exact specs for LinkedIn, YouTube, website, and paid media campaigns.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200" },
    { id: "scale", title: "Scale Without Quality Loss", description: "Our editing team handles high-volume content programmes — 20, 50, or 100+ videos per month.", image: "https://images.unsplash.com/photo-1594904351111-a072f80b1a71?auto=format&fit=crop&q=80&w=1200" },
  ],
};

export const VES_DELIVERABLES = {
  eyebrow: "WHAT'S INCLUDED",
  heading: (<>Full-Service Video <br /><span className="text-transparent bg-clip-text bg-linear-to-r from-brand-blue to-brand-cyan">Editing Package</span></>),
...
export const VES_STATS = {
  heading: (<>Editing Volume <br /><span className="text-brand-blue">& Quality Numbers</span></>),
...
export const VES_TESTIMONIALS = {
  ...
  heading: (<>Teams That Scaled <br /><span className="text-[#1E6091]">Their Video Output</span></>),
  autoplayInterval: 3500, initialIndex: 1,
  testimonials: [
    { id: 1, name: "David Alaba", designation: "Head of Growth", company: "Synapse Networks", rating: 5, quote: "We had months of footage gathering dust. B2B Sales Arrow's editing team turned it into 40+ platform-ready videos in 3 weeks. Our content engine is now running.", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=400" },
    { id: 2, name: "Sophia Martinez", designation: "VP Marketing", company: "Elevate Logistics", rating: 5, quote: "48-hour turnaround on video edits changed how we operate. We can now react to trends with polished video content the same week.", image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&q=80&w=400" },
    { id: 3, name: "Michael Chen", designation: "VP of Global Sales", company: "Aura Systems", rating: 5, quote: "The brand consistency across our entire video library is now exceptional. Every video looks like it came from the same world-class production house.", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=400" },
  ],
};
...
export const VES_FAQ = {
  ...
  scrollAmount: 340,
  faqs: [
    { id: "format", question: "What file formats do you accept for raw footage?", answer: "We accept all major formats including MP4, MOV, MXF, R3D, BRAW, and ProRes. We can work with footage from any camera system or screen recording software." },
    { id: "turnaround", question: "How fast is your standard turnaround?", answer: "Standard edits (under 5 minutes): 48 hours. Long-form content (5–30 min): 5 business days. Urgent same-day editing is available at a premium for event content." },
    { id: "revisions", question: "How many revision rounds are included?", answer: "All projects include 2 revision rounds. Additional revisions are available at an hourly rate. Our detailed brief process minimises the need for revisions." },
    { id: "retainer", question: "Do you offer monthly editing retainers?", answer: "Yes. Our monthly retainer plans offer priority turnaround, dedicated editors, and volume pricing for teams producing 10+ videos per month." },
    { id: "brand", question: "Can you match our brand guidelines exactly?", answer: "Yes. We work from your brand kit — fonts, colours, logo usage, motion style — and create a master template library so every video is pixel-perfect to your identity." },
  ],
};

export const VES_CONTACT = {
  eyebrow: "START YOUR EDITING PROJECT",
  heading: (<>Transform Your <br /><span className="text-transparent bg-clip-text bg-linear-to-r from-brand-blue to-brand-cyan">Raw Footage</span></>),
  description: "Send us your footage and brand guidelines — we'll turn it into polished B2B video content that performs.",
  ...
  form: {
    ...
    serviceLabel: "Edit Type", servicePlaceholder: "Select edit type...",
    serviceOptions: [
    ...
    messageLabel: "Describe Your Project", messagePlaceholder: "Volume of footage, desired output length, platform, and deadline...",
